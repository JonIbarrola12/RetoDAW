...
class MensajesGrupos {
    ...
    public function getMensajeGrupoId(): ?int {
        return $this->mensajeGrupoId;
    }

    public function setMensajeGrupoId(int $mensajeGrupoId): void {
        $this->mensajeGrupoId = $mensajeGrupoId;
    }
